...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        """
        # Creating an emty DataFrame using the meta file column names
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        """
        Creating a list of dates based in the input first_date and the already
        ...
        try:
            ...
            if dates_missing:
                ...
                # Setting values for the earliest date and list of dates
                return_dates = []
