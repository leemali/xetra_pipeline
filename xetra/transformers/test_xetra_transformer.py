...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        # mocking s3 connetion start
        self.mock_s3 = mock_s3()
        self.mock_s3.start()
        # Defining the class argument
        self.s3_access_key = "AWS_ACCESS_KEY_ID"
        self.s3_secret_key = "AWS_SECRET_ACCESS_KET"
        ...
        # Creating s3 access keys as envronment variables
        ...
        conf_dict_trg = {
            ...
            "trg_key": "report1/xetra_daiy_report1_",
    ...
    def test_load(self):
        ...
        """
        # Expected results
        log1_exp = "Xetra target data written successfully."
        log2_exp = "Xetra meta file updated successfully."
        df_exp = self.df_report
    ...
    def test_etl_report1(self):
        ...
        # Test init
        extract_date = "2021-04-17"
        exctract_date_list = ["2021-04-16", "2021-04-17", "2021-04-18", "2021-04-19"]
        # Method execution
        with patch.object(MetaProcess, "return_date_list",
        return_value=[extract_date,exctract_date_list]):
            xetra_etl = XetraETL(self.s3_bucket_src, self.s3_bucket_trg,
                         self.meta_key, self.source_config, self.target_config)
